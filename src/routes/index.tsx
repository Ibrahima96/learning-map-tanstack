		...
		<main className="relative min-h-screen overflow-hidden px-4 py-8 text-[var(--sea-ink)] sm:px-6 sm:py-12 lg:py-16">
			...
			<div className="page-wrap relative z-10 grid min-h-[calc(100vh-4rem)] items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
				<section className="rise-in space-y-8">
					<div className="inline-flex items-center gap-2 rounded-full border border-[var(--chip-line)] bg-[var(--chip-bg)] px-4 py-2 text-[11px] font-bold uppercase tracking-[0.22em] text-[var(--kicker)] shadow-[0_10px_30px_rgba(30,90,72,0.08)]">
