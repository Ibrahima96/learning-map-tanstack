        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="max-w-md text-lg text-muted-foreground leading-relaxed">
              Fill in the details to register a new student. Our system ensures
              data integrity and provides an instant preview in the registry.
            </p>
          </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Minimal required fields for fast intake.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Profile becomes available immediately after submission.
                </p>
              </div>
            </div>
          </div>
